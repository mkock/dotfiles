...
"==============================================================================
"Markdown Preview Recommended ettings
"****************************************************
...
lua require("lux") 
nnoremap <C-_> <cmd>lua require("lux").curr_buf() <cr>
...
nnoremap <F4> :lua package.loaded.lux = nil <cr>:source ~/.config/nvim/init.vim <cr> 
nnoremap <F3> :Telescope find_files cwd=~/Notes
